...
def upload_to_hf(directory_path,commit_message="Add audio segments"):
    ...
    api.upload_folder(
        ...
        repo_id=repo_id,
        repo_type="dataset",
        path_in_repo=f'PATH_IN_REPO/{directory_path}',
...
with DAG('download_CHANNEL_NAME',
    ...
    @task
    def download_video(video_url, download_path="DOWNLOAD_PATH",channel='CHANNEL_NAME'):
        ydl_opts = {
    ...
    task_get_videos = get_videos_list(channel_url='YOUTUBE_CHANNEL_URL', num_videos=10)
