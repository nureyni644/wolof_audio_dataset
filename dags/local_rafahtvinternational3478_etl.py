...
def upload_to_hf(directory_path,commit_message="Add audio segments"):
    ...
    api.upload_folder(
        ...
        repo_id=repo_id,
        repo_type="dataset",
        path_in_repo=f'rafahtvinternational3478/{directory_path}',
...
with DAG('download_rafahtvinternational3478',
    ...
    @task
    def download_video(video_url, download_path="rafah",channel='rafahtvinternational3478'):
        ydl_opts = {
    ...
    task_get_videos = get_videos_list(channel_url='https://www.youtube.com/@rafahtvinternational3478/videos', num_videos=10)
