...
def upload_to_hf(directory_path,commit_message="Add audio segments"):
    ...
    api.upload_folder(
        ...
        repo_id=repo_id,
        repo_type="dataset",
        path_in_repo=f'fafatv-sn/{directory_path}',
...
with DAG('download_fafatv-sn',
    ...
    @task
    def download_video(video_url, download_path="fafa",channel='fafatv-sn'):
        ydl_opts = {
    ...
    task_get_videos = get_videos_list(channel_url='https://www.youtube.com/@fafatv-sn/videos', num_videos=10)
