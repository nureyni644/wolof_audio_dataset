...
def upload_to_hf(directory_path,commit_message="Add audio segments"):
    ...
    api.upload_folder(
        ...
        repo_id=repo_id,
        repo_type="dataset",
        path_in_repo=f'rts-radiotelevisionsenegalaise/{directory_path}',
...
with DAG('download_rts-radiotelevisionsenegalaise',
    ...
    task_get_videos = get_videos_list(channel_url='https://www.youtube.com/@rts-radiotelevisionsenegalaise/videos', num_videos=10)
