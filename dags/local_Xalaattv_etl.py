...
def upload_to_hf(directory_path,commit_message="Add audio segments"):
    ...
    api.upload_folder(
        ...
        repo_id=repo_id,
        repo_type="dataset",
        path_in_repo=f'Xalaattv/{directory_path}',
...
with DAG('download_Xalaattv',
    ...
    @task
    def download_video(video_url, download_path="xalaattv",channel='Xalaattv'):
        ydl_opts = {
    ...
    task_get_videos = get_videos_list(channel_url='https://www.youtube.com/@Xalaattv/videos', num_videos=10)
